            ...
            <div className="flex-1 overflow-y-auto space-y-8 min-h-0 pb-12 custom-scrollbar pr-2">
                ...
                <section>
                    ...
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-2">
                        ...
                        {openDecisions.map(d => <DecisionCard key={d.id} d={d} onReview={setReviewingId} />)}
                    </div>
                </section>
                ...
                {reviewedDecisions.length > 0 && (
                    <section>
                        ...
                        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-2 opacity-80">
                            {reviewedDecisions.map(d => <DecisionCard key={d.id} d={d} onReview={setReviewingId} />)}
                        </div>
                    </section>
                )}
            </div>
