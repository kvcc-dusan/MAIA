                    ...
                    <div className="pt-1">
                      ...
                      <div className="flex items-center gap-6 mt-3">
                        <div className="relative">
                          <select
                            className="bg-white/5 border border-white/10 text-xs text-zinc-400 rounded-full pl-3 pr-8 py-1.5 outline-none hover:bg-white/10 transition-colors cursor-pointer appearance-none"
                          ...
                          <span className="absolute right-3 top-1/2 -translate-y-1/2 text-zinc-600 pointer-events-none text-[10px]">▼</span>
                        </div>
